...
- [agenttrace](https://github.com/luoyuctl/agenttrace) — Local-first TUI for inspecting AI coding agent session cost, tokens, elapsed time, and slow-run diagnostics.
